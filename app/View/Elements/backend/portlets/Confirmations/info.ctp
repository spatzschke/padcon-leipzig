...
$(document).ready(function() {
		...
		<div class="offerInfo">
			...
			<?php
				...
				echo $this->Form->input('confirmation_number', array('label' => false, 'data-model' => 'Confirmation', 'data-field' => 'confirmation_number', 'autoComplete' => false, 'div' => false, 'class' => 'noValid col-md-8'));	
				...
				echo '<div class="controls col-md-12">';
					...
					echo $this->Form->input('customer_id', array('type' => 'text', 'label' => false, 'data-model' => 'Confirmation', 'data-field' => 'customer_id', 'autoComplete' => false, 'div' => false, 'class' => 'noValid col-md-8'));
				
				echo '</div>';
				echo '<div class="controls col-md-12">';
							
				echo '<label for="ConfirmationAgent" class="col-md-4">Bearbeiter:</label>';
				echo $this->Form->input('agent', array('label' => false, 'data-model' => 'Confirmation', 'data-field' => 'agent', 'autoComplete' => false, 'div' => false, 'class' => 'noValid col-md-8'));
				echo '</div>';
				echo '<div class="controls col-md-12">';
