...
<div class="input-group address_dummy col-md-5 pull-left" style="margin-right: 10px">
    ...
    ?>	
     <span class="input-group-addon address-buttons">
    	<?php echo $this->Html->link('<i class="glyphicon glyphicon-pencil edit_btn"></i>', '/admin/Addresses/edit'.'/'.$customer_id.'/'.$address['id'], array('class' => 'btn btn-default', 'escape' => false)); ?>
    	<br><br><br><br><br><br>
