<div class="addresstypes index">
	<h2><?php echo __('Addresstypes'); ?></h2>
	...
	<tr>
		...
		<td><?php echo h($addresstype['Addresstype']['created']); ?>&nbsp;</td>
		<td><?php echo h($addresstype['Addresstype']['modified']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $addresstype['Addresstype']['id']), null, __('Are you sure you want to delete # %s?', $addresstype['Addresstype']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
